...
class PlayerObserver:
    ...
    def __str__(self):
        return f'Player {self.id} {self.player_info["type"]} won {self.wins} games with scores of {self.player_info["scores"]}'
    ...
    def observe(self):
        ...
        self.player_info['scores'].append(self.player.get_worth())
        self.player_info['type'] = self.player.get_type()
